export const renderMoviesToDOM = (movieHTML) => {
 ...
 Inside the function, we use document.getElementById('movie-list') 
 to select the DOM element with the ID "movie-list". This is the element where we want to insert the movie cards.
 ...
 We then check if the movieList element exists using an if statement:
     ...
     If movieList is null or undefined (falsy), indicating that no element with the ID "movie-list" was found, 
